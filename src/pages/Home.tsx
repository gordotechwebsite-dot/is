      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-[#f6f4f1] to-[#ece8e2]">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 w-full">
          <div className="relative flex justify-center items-start animate-scale-in">
            ...
            <div className="relative w-full flex justify-around items-start px-2 sm:px-8 lg:px-16">
              <img
                src="/images/products/iphone-16-purple.webp"
                alt="iPhone"
                className="w-44 sm:w-64 lg:w-[22rem] h-auto object-contain drop-shadow-2xl animate-float"
