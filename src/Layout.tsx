  ...
  return (
    <div className="min-h-screen bg-pearl flex flex-col">
          ...
          <div className="md:hidden bg-pearl border-t border-gray-100 animate-fade-in">
            <div className="px-4 py-4 space-y-3">
              ...
              <div className="flex justify-center gap-6 pt-4 border-t border-gray-100">
                ...
                <a href="https://www.instagram.com/isphone_sas" target="_blank" rel="noopener noreferrer" className="w-10 h-10 flex items-center justify-center">
                  <svg className="w-7 h-7" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer"
        ...
        <WhatsAppIcon className="w-14 h-14 md:w-20 md:h-20" />
      </a>
